...
class OfflineStateRun extends Education
{
    /***********************************************************************************/
    //----------------------------线下面审页面--------------------------------------
    /***********************************************************************************/
     ...
     * @return Json
     */
    public function getOfflineList(): Json
    {
        ...
        if ($this->request->isPost()) {
            ...
            try {
                ...
                if($data['status'] == 1) {
                    ...
                    $update['public_school_id'] = $school_id;//意愿学校
            ...
            if($is_limit) {
                ...
                foreach ($list['data'] as $k => $v){
                    ...
                    if($v['school_attr'] != $school['school_attr']){
                        $list['data'][$k] = $empty_data;
                        $list['data'][$k]['msg'] = '【' . $this->result['keyword']. '】申报为民办学校！';
                        $merge = 1;
                        continue;
                    }
