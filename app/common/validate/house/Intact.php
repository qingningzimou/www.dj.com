...
class Intact extends Validate
{
    protected $rule = [
        ...
        'primary_manager_id' => 'require|number',
        'middle_school_id' => 'require|number',
        'middle_manager_id' => 'require|number',
    ];
    ...
    protected $message = [
        ...
        'primary_manager_id.require' => '小学管理员ID不能为空',
        'primary_manager_id.number' => '小学管理员ID只能为数字',
        'middle_school_id.require' => '中学ID不能为空',
        'middle_school_id.number' => '中学ID只能为数字',
        'middle_manager_id.require' => '中学管理员ID不能为空',
        'middle_manager_id.number' => '中学管理员ID只能为数字',
    ];
